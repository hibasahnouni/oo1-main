...
import 'package:oo/view/chat_view/chatscreen_list.dart' show ChatWithUserByIdScreen;
  ...
  Future<void> _fetchUsers() async {
    try {
      final response = await supabase
          .from('profiles')
          .select()
          .inFilter('user_type', ['Teacher', 'Admin']); // ✅ Filtre ici
            ...
            child: InkWell(
              onTap: () {
                Navigator.push(
                  context,
                  MaterialPageRoute(
                    builder: (context) => ChatWithUserByIdScreen(
                      userId: user['id'],
                    ),
                  ),
                );
